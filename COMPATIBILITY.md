...
1. **Pin a released tag, not a branch.** Depend on a tag (e.g. `v0.5.3`), never
   ...
   - Python: `pip install "git+https://github.com/promaka/ajar-connectors.git@v0.5.3#subdirectory=python"`
   - C++: check out the `v0.5.3` tag (or vendor it) and build per [cpp/README.md](cpp/README.md).
