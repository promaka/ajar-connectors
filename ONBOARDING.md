...
Pick a language and add the SDK. **Pin the released version `0.5.8`, not a
...
```toml
[dependencies]
ajar-connector = "0.5.8"
```

**Go**:
```bash
go get github.com/promaka/ajar-connectors/go/ajarconnector@v0.5.8
```

**Python**:
```bash
pip install ajar-connector==0.5.8
...
> git clone --depth 1 --branch v0.5.8 https://github.com/promaka/ajar-connectors
> cd ajar-connectors
