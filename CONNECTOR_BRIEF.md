...
key and the **data contract** below — supplied to the operator directly, and never
added to any public repository.
...
| **SDK version to pin** | `v0.5.11` |

## What you do — 5 steps

1. **Copy a starting point** for your language and pin the SDK to `v0.5.11`:
