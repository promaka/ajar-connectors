...
```bash
curl -LO https://github.com/promaka/ajar-connectors/releases/download/v0.6.2/ajar-connector-cpp-0.6.2.tar.gz
curl -LO https://github.com/promaka/ajar-connectors/releases/download/v0.6.2/ajar-connector-cpp-0.6.2.tar.gz.sha256
sha256sum -c ajar-connector-cpp-0.6.2.tar.gz.sha256

tar xzf ajar-connector-cpp-0.6.2.tar.gz && cd ajar-connector-cpp-0.6.2
...
`ontology-mim-5.3-conformant-4.json`. That file is the contract your events are
