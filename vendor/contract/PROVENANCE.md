...
- Files:
  ...
  - ontology.json     <- core/docs/contract/ontology.json   (mim-5.3-conformant-4, core main ed2fd05, vendored 2026-09-14; revisions 2 to 4 are additive, CONTRACT_VERSION stays v1 because the wire is unchanged)
